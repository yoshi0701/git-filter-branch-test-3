    ...
    <div className="container">
      <header
        ...
        <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
          <li><NavLink to={'/'} exact activeClassName='link-dark' className="nav-link px-2 link-secondary">Frontend</NavLink></li>
          <li><NavLink to={'/backend'} activeClassName='link-dark' className="nav-link px-2 link-secondary link-dark">Backend</NavLink></li>
        </ul>
